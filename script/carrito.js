...
function cargarProductosCarrito() {
    ...
    if (carrito.length === 0) {
        ...
        document.querySelector('#tabla_carrito').innerHTML = '<tr><td colspan="6" style="text-align: center; padding: 20px;">Tu pedido está vacío. Elegí lo que te apetezca en nuestro <a href="./menu.html">menú</a>.</td></tr>';
    } else {
