...
const API_URL = 'https://raw.githubusercontent.com/aguscateura/lodeviru/refs/heads/main/productos.json';
...
async function llamarAPI(API) {
    try {
        ...
        productosGlobales = productosGlobales.slice(0, 12); // Limitar a los primeros 12 productos
